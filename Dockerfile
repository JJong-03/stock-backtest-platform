...
# Cache optimization: install dependencies before copying source code
...
# Source code copy (includes data/ for reproducibility)
COPY . .

EXPOSE 5000

# Optional health check based on /health endpoint
